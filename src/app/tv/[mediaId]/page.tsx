...
export default async function TVPage({ params }: { params: { mediaId: string } }) {
        ...
        <Section>
          <div className="-mt-36 grid grid-cols-4 gap-12">
            ...
            <div className="col-span-3 mt-36">
              ...
              {first_air_date && <h2 className="mt-2 text-3xl">({first_air_date.split("-")[0]})</h2>}
                ...
                <div className="mt-14">
                  ...
                  <div className="mt-8 flex items-center gap-4">
                    <Image
                      ...
                      src={MOVIE_DB_IMG_PATH_PREFIX + last_episode_to_air.still_path}
                      width={300}
                      height={300}
                    ...
                    <div>
                      <h3 className="text-sm">
                        Season {last_episode_to_air.season_number} Episode {last_episode_to_air.episode_number}
                      </h3>
                      <h3 className="text-2xl font-bold">{last_episode_to_air.name}</h3>
                      <p className="text-xs text-stone-400">{last_episode_to_air.runtime} mins</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="flex flex-col gap-2">
                ...
                {recentReviews?.length === 0 && <p className="mt-8 text-stone-400">There are no reviews yet for {name}.</p>}
              </div>
            </div>
          </div>
        </Section>
