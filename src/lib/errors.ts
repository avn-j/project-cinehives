export const E = {
  USER_AUTHENTICATION_ERROR: "User is not authenticated",
  WATCHLIST_ID_NOT_FOUND: "Could not retrive a watchlist ID",
  MEDIA_ID_NOT_FOUND: "Could not retrieve a media ID",
